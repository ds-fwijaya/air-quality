...
full_data$`Pollutant Grade`<-as.factor(full_data$`Pollutant Grade`)
full_data$`Ozone Grade`<-as.factor(full_data$`Ozone Grade`)
full_data$`Annual Pass/Fail`<-as.factor(full_data$`Annual Pass/Fail`)

full_data$`Annual Pass/Fail`<-factor(full_data$`Annual Pass/Fail`,c("PASS","INC","DNC"))
```
